...
| [user put into basket] | Добавляет/убавляет товары в корзине, возвращает содержимое корзины (см. выше) "goods_add": "1" добавляет к количеству +1 товар,  "5" добавляет 5 и т.д.  "goods_add": "-1" убавляет -1 товар.  |                                          
